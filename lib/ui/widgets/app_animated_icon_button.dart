...
class AppAnimatedIconButton extends StatelessWidget {
  ...
  AppAnimatedIconButton({
    ...
    this.animDuration = const Duration(milliseconds: 550)});
  ...
  Widget build(BuildContext context) {
    ...
    final multiTween = MultiTween<AniProps>()
      ..add(AniProps.color, Colors.white.tweenTo(Colors.blueAccent), halfAnimDuration)
      ..add(AniProps.color, Colors.blueAccent.tweenTo(Colors.white), halfAnimDuration)
